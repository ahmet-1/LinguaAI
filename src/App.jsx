...
const kulGiris = u => {
  ...
  return (
    <div style={{minHeight:"100vh",background:"linear-gradient(170deg,"+K.bg+","+K.bg2+" 50%,"+K.bg+")",fontFamily:"'Segoe UI',system-ui,sans-serif",fontSize:"17px"}}>
      <style>{`@media(max-width:768px){*{font-size:118%!important;line-height:1.6!important;}}@media(max-width:768px){*{font-size:118%!important;line-height:1.6!important;}}@media(max-width:768px){*{font-size:118%!important;line-height:1.6!important;}}*{box-sizing:border-box}
