  ...
  return (
    <div style={{position:"fixed",inset:0,background:K.bg,display:"flex",flexDirection:"column",zIndex:8000}}>
      ...
      <div style={{display:"flex",flex:1,overflow:"hidden"}}>
        <div style={{width:185,background:K.bg2,borderRight:"1px solid "+K.bdr,padding:10,display:window.innerWidth<=768?"none":"flex",flexDirection:"column",gap:8,overflowY:"auto"}}>
